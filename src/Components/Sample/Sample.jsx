...
import { useGetSamplesQuery } from '../Redux/api/sampleApi';
import Lottie from 'lottie-react';
import Loader from "../../assets/loader2.json"

const Sample = () => {
    const { deleteSample, updateSample } = useContext(JobContext);
    const { data: sample, isLoading, refetch } = useGetSamplesQuery()
    ...
    return (
        <div className='mt-20 mb-10 flex justify-center'>
            {
                isLoading ? <Lottie animationData={Loader} /> :
