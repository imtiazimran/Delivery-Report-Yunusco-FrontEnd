            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:px-10 justify-center">
                {
                    users?.map(user => (
                        <div key={user._id} className="card w-80 mx-auto glass">
                            <figure className='pt-10 pb-3'>
                                <div className="indicator">
                                    <span className={`${user.role === "Admin" ? "" : "hidden"} indicator-item indicator-bottom badge-ghost rounded-full right-[4px] bottom-1`}>
                                    ...
                                    <img className=' w-[150px] h-[150px]' src={user.image ? user.image : "https://static.vecteezy.com/system/resources/previews/011/490/381/non_2x/happy-smiling-young-man-avatar-3d-portrait-of-a-man-cartoon-character-people-illustration-isolated-on-white-background-vector.jpg"} alt="car!" />
                                </div>
                            </figure>
